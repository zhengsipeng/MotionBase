...
def get_args_parser():
    ...
    parser.add_argument('--split-name', type=str, default='train.txt', help='split name')
    parser.add_argument('--meta-dir', type=str, default='', help='meta dir')
    parser.add_argument('--val-meta-dir', type=str, default='checkpoints/t2m/VQVAEV3_CB1024_CMT_H1024_NRES3/meta', help='val meta dir')
    parser.add_argument('--val-split-name', type=str, default='val/test.txt', help='val split name')
    parser.add_argument('--min-motion-len', type=int, default=24, help='min motion len')
    parser.add_argument('--max-motion-len', type=int, default=196, help='max motion len')

    parser.add_argument('--instructions', type=str, nargs='+', default=[], help='A list of strings')

    parser.add_argument('--text-mot-match-path', type=str, default="", help='text_mot_match_path')
    ...
    parser.add_argument('--num_gpu', default=1, type=int, help='gpu num')
