...
def get_args_parser():
    ...
    parser.add_argument('--split-name', type=str, default='train', help='split name')
    parser.add_argument('--meta-dir', type=str, default='checkpoints/t2m/VQVAEV3_CB1024_CMT_H1024_NRES3/meta', help='meta dir')
